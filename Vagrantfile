...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "vagrant1" do |vagrant1|
        ...
        if type python3 > /dev/null 2>&1;then
            ...
            if [ $rc -eq 0 ] ;then
                ...
                echo "install error:unable to isntall python3"
            fi
        fi
        SCRIPT
    end
  ...
  #     #vagrant2.vm.network "private_network" , ip: "192.168.33.10"
  #      vagrant2.vm.provision "shell",inline: $script
  #  end
  ...
  #     #vagrant3.vm.network "private_network" , ip: "192.168.33.10"
  #      vagrant3.vm.provision "shell",inline: $script
  #  end
